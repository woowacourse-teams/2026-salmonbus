...
readonly CATCHUP_DATE="2026-09-02"
readonly SNAPSHOT_AT="2026-09-02T12:01:52.931Z"
readonly TARGET_AUTHORITY_FROM="2026-09-02T10:27:52.390820Z"
...
python3 "$SCRIPT_DIRECTORY/audit_catchup.py" \
  --bucket "$COLLECTOR_BUCKET" \
  --region "$AWS_READ_REGION" \
  --date "$CATCHUP_DATE" \
  --snapshot-at "$SNAPSHOT_AT" \
  --target-authority-from "$TARGET_AUTHORITY_FROM" \
