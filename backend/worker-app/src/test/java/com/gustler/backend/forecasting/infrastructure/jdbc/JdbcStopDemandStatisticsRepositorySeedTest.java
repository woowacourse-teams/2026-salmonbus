...
import com.gustler.backend.forecasting.application.statistics.RefreshDemandStatisticsService;
...
class JdbcStopDemandStatisticsRepositorySeedTest {
    ...
    private UUID insertAppliedSeedImport() {
        ...
        jdbcClient.sql("""
            ...
            .params(
                seedImportId,
                RefreshDemandStatisticsService.CURRENT_CALCULATION_VERSION,
