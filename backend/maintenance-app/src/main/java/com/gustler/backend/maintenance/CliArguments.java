...
final class CliArguments {
    ...
    String required(
        ...
        if (value == null || value.isBlank()) {
            throw new MaintenanceException("MISSING_ARGUMENT_" + name.replace('-', '_').toUpperCase());
        }
        return value;
    }
