...
/** Worker를 기동하지 않고 노선 판본 저장과 버전 교체를 검증한다. 각 모듈이 공개한 구성을 그대로 가져온다. */
@Configuration(proxyBeanMethods = false)
@EnableAutoConfiguration
@Import({PostgresTestContainer.class, ClockConfig.class, RouteCatalogConfiguration.class,
    CallQuotaConfiguration.class, GbisConfiguration.class})
class RouteCatalogPersistenceTestConfiguration {
