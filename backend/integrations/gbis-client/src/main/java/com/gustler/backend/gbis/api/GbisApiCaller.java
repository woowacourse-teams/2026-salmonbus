...
import com.gustler.backend.gbis.api.dto.PortalErrorResponse;
import com.gustler.backend.gbis.api.dto.PortalErrorResponse.CommonHeader;
...
public class GbisApiCaller {
    ...
    private final GbisClientOptions properties;
