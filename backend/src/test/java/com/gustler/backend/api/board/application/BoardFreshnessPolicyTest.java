...
class BoardFreshnessPolicyTest {
    ...
    void 관측_후_5분까지는_유효하다() {
        final BoardFreshnessPolicy policy = policyAt("2026-08-26T23:05:00Z");
    ...
    void 관측_후_5분을_넘으면_낡았다() {
        final BoardFreshnessPolicy policy = policyAt("2026-08-26T23:05:00.000000001Z");

        assertThat(policy.isStale(OBSERVED_AT)).isTrue();
    }

    private BoardFreshnessPolicy policyAt(final String instant) {
